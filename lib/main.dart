...
class _QrHomePageState extends State<QrHomePage> {
  ...
  final TextEditingController _fileNameController =
      TextEditingController(text: "qr_studio");
...
END:VEVENT""";
    ...
    try {
      ...
      if (byteData != null) {
        ...
        if (kIsWeb) {
          ...
          await Share.shareXFiles([XFile(path)], text: 'Shared via QR Studio');
        }
      }
    } catch (e) {
    ...
    return ListView(
      ...
      children: [
          ...
          builder: (context, constraints) {
            ...
            final childWidth =
                (constraints.maxWidth - (crossAxisCount - 1) * 8) /
                    crossAxisCount;
            final childHeight = 40.0; // fixed height in pixels for all children
        ...
        DropdownButtonFormField<int>(
          initialValue: _errorCorrectLevel,
          decoration: const InputDecoration(
  ...
  Widget _buildInputFields() {
    const commonInputDec = InputDecoration(border: OutlineInputBorder());
              ...
              children: [
                ...
                Expanded(
                  child: DropdownButtonFormField<String>(
                    initialValue: _controllers['hidden']?.text,
                    items: const [
